...
def customerNum = body.logon.customerNumber.text()
...
""";
        ...
        || '000000'.equals(customerNum) || '000401'.equals(customerNum) || '000403'.equals(customerNum)
        || '000500'.equals(customerNum) || '999997'.equals(customerNum) || '999998'.equals(customerNum)) {
    responseStr = """
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
<soapenv:Header/>
<soapenv:Body>
    <logonResponse xmlns="http://www.sandstone.com.au/ib/corewebclient/2012/04/">
        <requestId>${customerNum}</requestId>
        <sessionId>PWXD9Z4VTC</sessionId>
   ...
   <detail>
        ...
        <sst_inf:InformationSegment xmlns:sst_inf="http://www.sandstone.com.au/information">
            <sst_inf:Information Subtype="ERROR">
                ...
                <sst_inf:Text xml:lang="en">This is a Host error from BankFastAuthenticateExistingCustomerService. Invalid authentication details</sst_inf:Text>
            </sst_inf:Information>
        </sst_inf:InformationSegment>
   </detail>
</soapenv:Fault>
